...
public class CopperArmorItem extends ArmorItem {
    ...
    static {
        ...
        map.put(ModArmorMaterials.COPPER, new MobEffectInstance(MobEffects.DIG_SPEED, 300, 1, false, false, true));
    ...
    public CopperArmorItem(ArmorMaterial pMaterial, Type pType, Properties pProperties) {
