...
public class PrismarineArmorItem extends ArmorItem {
    ...
    static {
        ...
        map.put(ModArmorMaterials.PRISMARINE, new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 300, 1, false, false, true));
        map.put(ModArmorMaterials.PRISMARINE, new MobEffectInstance(MobEffects.CONDUIT_POWER, 300, 1, false, false, true));
